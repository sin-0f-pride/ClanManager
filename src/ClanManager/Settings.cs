...
namespace ClanManager
{
    public class Settings : AttributeGlobalSettings<Settings>
    {
        ...
        [SettingPropertyInteger("{=aIna4f85}Minimum Personality Trait Level", -2, 2, HintText = "{=CgnkpKzm}The minimum level for each personality trait. Cannot be higher than Maximum Personality Trait Level. Default is -2.", Order = 38, RequireRestart = false)]
        [SettingPropertyGroup(HeadingHeroProperties, GroupOrder = 30)]
        ...
        [SettingPropertyInteger("{=v73XjgH5}Maximum Personality Trait Level", -2, 2, HintText = "{=zauNoekp}The maximum level for each personality traits. Cannot be lower than Maximum Personality Trait Level. Default is 2.", Order = 39, RequireRestart = false)]
        [SettingPropertyGroup(HeadingHeroProperties, GroupOrder = 30)]
